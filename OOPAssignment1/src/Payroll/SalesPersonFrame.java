 ...
 *
 * Created on 28-Jan-2014, 14:18:59
 */
...
// The Public Class SalesPersonFrame.
public class SalesPersonFrame extends javax.swing.JFrame {

    /* This next line of code is where the New Object of the Sales Person Class is Being Created
       that will be used throughout this class to get Methods from the Sales Person Class. */
    salesPerson sprs = new salesPerson();
    ...
    private void initComponents() {
        ...
        setTitle("Sales Person Payments");
        ...
        salesPersonPanel.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Sales Person Details", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 14), new java.awt.Color(0, 0, 153))); // NOI18N
        ...
        salesPersonPanelLayout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] {addressText, ageText, dobText, nameText, payrollText, ppsText});

        salesPersonPanelLayout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] {addressLabel, ageLabel, dobLabel, nameLabel, payrollLabel, ppsLabel});

        salesPersonPanelLayout.setVerticalGroup(
            salesPersonPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(salesPersonPanelLayout.createSequentialGroup()
                .addContainerGap()
                .addGroup(salesPersonPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(nameLabel)
        ...
        salesAchievedLabel.setText("Sales Achieved:");
        ...
        salesAchievedText.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                salesAchievedTextKeyPressed(evt);
            }
            public void keyTyped(java.awt.event.KeyEvent evt) {
                salesAchievedTextKeyTyped(evt);
            }
        });
        ...
        salesAchievedMissingWarningLabel.setFont(new java.awt.Font("Tahoma", 1, 12));
        salesAchievedMissingWarningLabel.setForeground(new java.awt.Color(255, 0, 0));
        salesAchievedMissingWarningLabel.setText("*");
        ...
        paymentCalcPanelLayout.setHorizontalGroup(
            ...
            .addGroup(paymentCalcPanelLayout.createSequentialGroup()
                .addContainerGap()
                .addGroup(paymentCalcPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addGroup(paymentCalcPanelLayout.createSequentialGroup()
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, paymentCalcPanelLayout.createSequentialGroup()
                        .addComponent(salesAchievedLabel)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addComponent(salesAchievedText, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(paymentCalcPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(salesAchievedMissingWarningLabel))
                .addContainerGap(26, Short.MAX_VALUE))
        );

        paymentCalcPanelLayout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] {hourlyRateText, hoursworkedText, salesAchievedText});

        paymentCalcPanelLayout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] {hourlyRateLabel, hoursWorkedLabel, salesAchievedLabel});
        ...
        salesPersonHeadingLabel.setFont(new java.awt.Font("Tahoma", 1, 24));
        salesPersonHeadingLabel.setForeground(new java.awt.Color(0, 0, 153));
        salesPersonHeadingLabel.setText(" Sales Person Payment Page");
        salesPersonHeadingLabel.setBorder(javax.swing.BorderFactory.createEtchedBorder());
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGap(176, 176, 176)
                        .addComponent(salesPersonHeadingLabel, javax.swing.GroupLayout.PREFERRED_SIZE, 348, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addContainerGap())
        );
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(salesPersonHeadingLabel, javax.swing.GroupLayout.PREFERRED_SIZE, 41, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(layout.createSequentialGroup()
                        .addGap(11, 11, 11)
    ...
    private void writeToFileButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_writeToFileButtonActionPerformed
        ...
        else if(salesAchievedText.getText().isEmpty())
        {
            salesAchievedMissingWarningLabel.setVisible(true);
            requiredFieldWarningLabel.setVisible(true);
        }
        else if (nameText.getText().isEmpty() ||  addressText.getText().isEmpty() || ppsText.getText().isEmpty() || payrollText.getText().isEmpty() || dobText.getText().isEmpty() || ageText.getText().isEmpty() || hoursworkedText.getText().isEmpty() || hourlyRateText.getText().isEmpty() || salesAchievedText.getText().isEmpty())
        {
        ...
        {
            // The below uses the Gets/sets methods to Attach values from the TextFields to the Object sprs, of the Person Class.
            sprs.setName(nameText.getText());
            sprs.setAddress(addressText.getText());
            sprs.setPPSNo(ppsText.getText());
            sprs.setPayrollNo(Integer.parseInt(payrollText.getText()));
            sprs.setDOB(dobText.getText());
            sprs.setAge(Integer.parseInt(ageText.getText()));
            sprs.setHoursWorked(Integer.parseInt(hoursworkedText.getText()));
            sprs.setHourlyRate(Integer.parseInt(hourlyRateText.getText()));
            sprs.setSalesAchieved(Integer.parseInt(salesAchievedText.getText()));

        // This section deals with the writing to the outfile to a textfilecomplete with it's path.
        try {
            FileWriter outFile = new FileWriter("J:/NSS 2013 2014/05. Object Oriented Programming/PayrollOutfileFolder/SalesPersonPayments/" + sprs.getName() + ".txt");
            //FileWriter outFile = new FileWriter("F:/NSS 2013 2014/05. Object Oriented Programming/PayrollOutfileFolder/SalesPersonPayments/" + sprs.getName() + ".txt");
            ...
            out.println("---------------------------------------------------");
            out.println("");
            out.println("Sales Person " + sprs.getName() + " Info:");
            out.println("");
            out.println("Name: " + "               " + sprs.getName());
            out.println("\nAddress: " + "           " + sprs.getAddress());
            out.println("\nPPS No: " + "            " + sprs.getPPSNo());
            out.println("\nPayroll No: " + "        " + sprs.getPayrollNo());
            out.println("\nDOB: " + "                  " + sprs.getDOB());
            out.println("\nAge: " + "                    " + sprs.getAge());
            out.println("");
            out.println("---------------------------------------------------");
            out.println("");
            out.println("Sales Person " + sprs.getName() + " Wage details:");
            out.println("");
            out.println("Hours Worked: " + "                  " + sprs.getHoursWorked());
            out.println("Hourly Rate: " + "                       " + sprs.getHourlyRate());
            out.println("Sales Achieved: " + "                " + sprs.getSalesAchieved() + " Units Sold");
            out.println("Weekly Pay: " + "                      €" + sprs.calcWage(sprs.getHoursWorked(),(int) sprs.getHourlyRate()));
            out.println("Commission Earned: " + "    €" + sprs.getCommission());
            out.println("Gross Pay: " + "                        €" + sprs.grossPayCalc(sprs.calcWage(sprs.getHoursWorked(),(int) sprs.getHourlyRate()),(int) sprs.getCommission()));
            out.println("Tax Rate =                            20%");
            out.println("");
            out.println("/////////////////////////////////////////////////////////////////////");
            out.println("Net Pay: " + "                             €" + sprs.netPayCalc(sprs.getHoursWorked(),(int) sprs.getHourlyRate(), (int) sprs.getCommission()));
            out.println("/////////////////////////////////////////////////////////////////////");
            out.close();
...
//        String filename = f.getAbsolutePath();
        ...
        try
        {
            //FileReader reader = new FileReader("F:/NSS 2013 2014/05. Object Oriented Programming/PayrollOutfileFolder/SalesPersonPayments/" + sprs.getName() + ".txt");
            FileReader reader = new FileReader("J:/NSS 2013 2014/05. Object Oriented Programming/PayrollOutfileFolder/SalesPersonPayments/" + sprs.getName() + ".txt");
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        ...
        salesAchievedText.setEnabled(false);
        ...
        salesAchievedMissingWarningLabel.setVisible(false);
    ...
    private void hourlyRateTextKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_hourlyRateTextKeyPressed
        ...
        if(evt.getKeyCode()==java.awt.event.KeyEvent.VK_ENTER)
        {
            salesAchievedText.setEnabled(true);
            salesAchievedText.requestFocusInWindow();
        }
    ...
    private void salesAchievedTextKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_salesAchievedTextKeyPressed
    }//GEN-LAST:event_salesAchievedTextKeyPressed

    private void salesAchievedTextKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_salesAchievedTextKeyTyped
        // This Validation will allow only Numeric Values in the TextField.
        char charTyped = evt.getKeyChar();
    ...
    }//GEN-LAST:event_salesAchievedTextKeyTyped
    ...
    */
    ...
    private javax.swing.JLabel salesAchievedLabel;
    private javax.swing.JLabel salesAchievedMissingWarningLabel;
    private javax.swing.JTextField salesAchievedText;
    private javax.swing.JLabel salesPersonHeadingLabel;
